...
const baseData: Shipment[] = [
  ...
  },
  {
    ...
    weight: "2,500 kg",
    route: { origin: "Shanghai, China", destination: "Los Angeles, CA" },
    dates: { atd: "Mar 10, 2035 - 08:00 AM", eta: "Apr 05, 2035 - 10:00 AM" },
    progress: 45,
    status: "Delivery",
  },
  {
    ...
    weight: "450 kg",
    route: { origin: "London, UK", destination: "New York, NY" },
    dates: { atd: "Mar 22, 2035 - 02:00 PM", eta: "Mar 23, 2035 - 09:00 AM" },
    progress: 15,
    status: "Pending",
  },
  {
    ...
    company: { name: "FitPlus Gear", category: "Sports & Outdoors", logoColor: "bg-blue-600" },
    carrier: "UPS",
    productCategory: "Yoga Mats",
    weight: "780 kg",
    route: { origin: "Chicago, IL", destination: "Houston, TX" },
    dates: { atd: "Mar 15, 2035 - 06:30 AM", eta: "Mar 18, 2035 - 04:00 PM" },
    progress: 100,
    status: "Completed",
  },
  {
    ...
    company: { name: "AutoParts Pro", category: "Automotive", logoColor: "bg-slate-700" },
    carrier: "BNSF",
    productCategory: "Brake Pads",
    weight: "3,200 kg",
    route: { origin: "Detroit, MI", destination: "Atlanta, GA" },
    dates: { atd: "Mar 18, 2035 - 11:00 AM", eta: "Mar 24, 2035 - 01:00 PM" },
    progress: 60,
    status: "Delivery",
  },
  {
    ...
    company: { name: "StyleHub Co.", category: "Apparel", logoColor: "bg-indigo-500" },
    carrier: "FedEx",
    productCategory: "Winter Coats",
    weight: "620 kg",
    route: { origin: "Paris, France", destination: "Chicago, IL" },
    dates: { atd: "Mar 21, 2035 - 09:15 AM", eta: "Mar 22, 2035 - 05:30 PM" },
    progress: 80,
    status: "Delivery",
  },
  {
    ...
    productCategory: "LED Bulbs",
    weight: "1,150 kg",
    route: { origin: "Austin, TX", destination: "Seattle, WA" },
    dates: { atd: "Mar 19, 2035 - 08:00 AM", eta: "Mar 25, 2035 - 02:00 PM" },
    progress: 35,
    status: "Delivery",
  },
  {
    ...
    company: { name: "GreenHaven", category: "Home & Garden", logoColor: "bg-green-600" },
    carrier: "Evergreen",
    productCategory: "Patio Furniture",
    weight: "4,100 kg",
    route: { origin: "Rotterdam, NL", destination: "Miami, FL" },
    dates: { atd: "Mar 05, 2035 - 10:30 AM", eta: "Mar 28, 2035 - 08:00 AM" },
    progress: 70,
    status: "Delivery",
  }
];
