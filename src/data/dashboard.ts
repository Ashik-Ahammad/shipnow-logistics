...
export const productCategoriesData = {
  ...
  categories: [
    ...
    { name: "Home & Kitchen", count: 200, percentage: 20, color: "bg-[#E2DDFE]" },
    { name: "Apparel", count: 180, percentage: 18, color: "bg-[#333333]" },
    { name: "Beauty & Health", count: 140, percentage: 14, color: "bg-[#757575]" },
    { name: "Sports & Outdoors", count: 120, percentage: 12, color: "bg-[#E5E7EB]" },
    { name: "Automotive", count: 120, percentage: 12, color: "bg-[#F3F4F6]" },
  ]
};
