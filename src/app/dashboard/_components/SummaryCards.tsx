...
export default function SummaryCards() {
  return (
    <div className="grid grid-cols-1 gap-5 tablet:grid-cols-3">
      <div className="flex h-30 items-center justify-between rounded-[20px] bg-white p-5 shadow-[0px_2px_10px_rgba(0,0,0,0.02)]">
        <div>
          <h3 className="mb-1.5 text-[14px] font-medium text-[#757575]">
            Active Shipments
          </h3>
          <div className="mb-2 flex items-baseline gap-1.5">
            <span className="text-[28px] font-bold text-[#333333]">1,284</span>
      ...
      <div className="flex h-30 items-center justify-between rounded-2xl bg-white p-5 shadow-[0px_2px_10px_rgba(0,0,0,0.02)]">
        <div>
          <h3 className="mb-1.5 text-[14px] font-medium text-[#757575]">
            Delivery Performance
          </h3>
          <div className="mb-2 flex items-baseline gap-1.5">
            <span className="text-[28px] font-bold text-[#333333]">94.3%</span>
            <span className="text-[12px] font-medium text-[#A3A3A3]">
              on-time
            </span>
          </div>
