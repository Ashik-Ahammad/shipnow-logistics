    ...
    <header className="z-40">
      ...
      <div className="flex flex-col gap-4 tablet:hidden">
        ...
        <div className="flex gap-2">
          ...
          <button className="flex h-10.5 w-10.5 shrink-0 cursor-pointer items-center justify-center rounded-lg bg-[#232323] text-white transition-colors hover:bg-black">
      ...
      <div className="hidden items-center justify-between tablet:flex">
        ...
        <div className="flex items-center gap-2.5">
          <div className="relative w-70 desktop:w-[320px]">
          ...
          <button className="flex cursor-pointer items-center gap-2 rounded-lg bg-[#333333] px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-black">
