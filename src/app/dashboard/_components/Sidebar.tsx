...
const mainNav = [
  ...
  { name: "Analytics", href: "/analytics", icon: "/icons/analytics.svg" },
  { name: "Calendar", href: "/calendar", icon: "/icons/calendar.svg" },
  { name: "Shipments", href: "/shipments", icon: "/icons/shipments.svg" },
  { name: "Tracking", href: "/tracking", icon: "/icons/tracking.svg" },
  { name: "Warehouse", href: "/warehouse", icon: "/icons/warehouse.svg" },
  { name: "Fleets", href: "/fleets", icon: "/icons/fleets.svg" },
  { name: "Drivers", href: "/drivers", icon: "/icons/drivers.svg" },
  { name: "Invoices & Billing", href: "/invoices", icon: "/icons/invoice.svg" },
];
...
export default function Sidebar({ onMobileClose }: SidebarProps) {
  ...
  return (
    <div className="flex h-full w-22.5 flex-col border-r border-gray-100 bg-white transition-all duration-300 desktop:w-65">
      ...
      <div className="mb-6 px-3 desktop:px-6">
        <button className="flex w-full cursor-pointer items-center justify-center rounded-lg p-2 transition-colors bg-[#F0F0F0] desktop:justify-between">
          ...
          <ChevronDown className="hidden h-4 w-4 text-[#333333] desktop:block mr-[10.5]" />
        </button>
      </div>
